...
function updateFeature(feature, oldLayer) {
    touch(feature)
    feature.properties = feature.properties || {}
...
function getFeatureId(feature, errmsg) {
...
// Get or generate a feature id
function getLayerFeatureId(layer) {
...
//      2.1. properties.name
//      2.2. properties.type
function isValidGIPGeoJSONFeature(feature) {
    /*
 ...
 */
function version() {
    console.log('Util', Oscars.version);
}
