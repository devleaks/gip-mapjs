...
import { control } from 'leaflet/src/Leaflet'
...
function install_hmtl() {
    ...
    */
    _layerControl = control.layers(null, null, _options.layerControlOptions)
