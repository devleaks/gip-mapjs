L.Control.BetterScale = L.Control.extend({
    ...
    _addScales: function (t, e, i) {
        ...
        this._mScale = L.DomUtil.create("div", e + "-label-div", i), this._mScaleLabel = L.DomUtil.create("div", e + "-label", this._mScale), this._mScaleFirstNumber = L.DomUtil.create("div", e + "-label " + e + "-first-number", this._mScale), this._mScaleSecondNumber = L.DomUtil.create("div", e + "-label " + e + "-second-number", this._mScale)
    },
    _update: function () {
    ...
    _updateMetric: function (t) {
		...
		var e = this._getRoundNum(t), i, n, o, s, a,
		            r = this._mScaleFirstNumber,
		            h = this._mScaleSecondNumber,
		            l = this._mScale,
		            u = this._mScaleLabel;
